...
export const NIGHT_PLANT_SPAWN_CHANCE = 0.015;
export const MAX_AUTO_PLANTS = 20;
export const OVERPOWER_WIRE_NEIGHBORS = 5;
export const HIGH_POWER_CONSUMER_RANGE = 1;
